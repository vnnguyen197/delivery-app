        ...
        <StyleListLeft>
          ...
          >
            <StyleRulesGroup>
              ...
              <>
                <StyleRules>
                  1. Người dùng đồng ý và cam kết không gửi bất kỳ hàng hóa nào
                  vi phạm pháp luật khi sử dụng dịch vụ giao hàng nhanh được
                  cung cấp bởi chúng tôi.
                </StyleRules>
                <StyleRules>
                  2. Người dùng xác nhận rằng tất cả các hàng hóa gửi đi đều
                ...
                <StyleRules>
                  3. Người dùng cam kết rằng thông tin về hàng hóa gửi đi là
                  chính xác, đầy đủ và không gian lận. Người dùng chịu trách
                ...
                <StyleRules>
                  ...
                  cũng có quyền chấm dứt hoặc tạm ngừng dịch vụ cho Người dùng
                ...
                <StyleRules>
                  ...
                  xác hoặc hợp pháp của hàng hóa gửi đi bởi Người dùng. Người
                ...
                <StyleRules>
                  ...
                  Người dùng để có thời gian thích hợp để xem xét và chấp nhận
                  các điều khoản mới.
                </StyleRules>
                <StyleRules>
